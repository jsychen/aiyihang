<template>
    <div class="wrap">
       <mt-field label="原姓名" :disabled="true"  v-model="username"></mt-field>
       <mt-field label="新姓名" placeholder="请输入新姓名" v-model="newusername"></mt-field>
    ...
    methods:{
        submit(){
            ...
            this.$ajax({
                method: 'post',
                url:'member/update',
                data:this.$qs.stringify({openId:that.openid,name:that.newusername})
            }).then((res)=>{
